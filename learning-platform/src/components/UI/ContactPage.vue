...
<section>
  ...
  <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" id="hero3">
        <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5" >
            <form @submit.prevent="submitData">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <textarea name="" id="" class="form-control" placeholder="Write your message." cols="30" rows="10" required v-model="message"></textarea>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-6 mr-auto">
                  <input type="submit" class="btn btn-block btn-primary text-white py-3 px-5" v-if="updateButton === false" value="Send Message">
                  <input type="submit" class="btn btn-block btn-primary text-white py-3 px-5" v-if="updateButton === true" value="Update" @submit.prevent="updateData">
                </div>
              </div>
            </form> 
  ...
  <tbody>
    <tr v-for="em in emails" :key="em.id">
      ...
      <td>
        ...
        <button @click="editData(em)">Edit</button>
        <button @click="updateData(em)">Update</button>
...
export default {
      ...
      emails: [
        {
          firstName: 'Serge',
          lastName: 'Anan',
          email: 'sergetassiga@localhost.com',
          message: 'Hello'
  ...
  methods: {
    submitData() {
      ...
      /* fetch('http://www.ihfy5459.odns.fr/api-test/public/', {
    ...
    updateData(data) {
     ...
     /*  this.emails.replace(
        {
          (data.firstName = this.firstName), (data.lastName = this.lastName), (data.email = this.email), (data.message = this.message)
        }
      ) */
     console.log(data);
      this.firstName = this.firstName.replace(data.firstName = this.firstName);
      this.lastName = this.lastName.replace(data.lastName =  this.lastName);
      this.email = this.email.replace(data.email = this.email);
      this.message = this.message.replace(data.message = this.message);
