<template>
  <section>
       <div class="site-section section-3" data-stellar-background-ratio="0.5" id="hero2">
      <div class="container">
    ...
    <div class="site-section section-3" data-stellar-background-ratio="0.5" id="hero3">
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-7 text-center mb-5">
